  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "landing-plant-help": {
          "0%, 32%": { opacity: "0", strokeDashoffset: "48" },
          "42%, 88%": { opacity: "1", strokeDashoffset: "0" },
          "100%": { opacity: "0.5", strokeDashoffset: "12" },
        },
      },
      animation: {
        ...
        "landing-plant-soil": "landing-plant-soil 18s ease-out infinite",
        "landing-plant-root": "landing-plant-root 18s ease-out infinite",
        "landing-plant-stem": "landing-plant-stem 18s ease-out infinite",
        "landing-plant-leaf-left": "landing-plant-leaf-left 18s ease-out infinite",
        "landing-plant-branch": "landing-plant-branch 18s ease-out infinite",
        "landing-plant-leaf-top": "landing-plant-leaf-top 18s ease-out infinite",
        "landing-plant-node": "landing-plant-node 18s ease-in-out infinite",
        "landing-plant-help": "landing-plant-help 18s ease-out infinite",
        "landing-plant-halo": "landing-plant-halo 18s ease-out infinite",
